...
const ROOT = "Photos/femme/alo/products/ensemble brassiere short legging/style 2";
const OUT = "Photos/femme/alo/_grids_styles/style-2-verify.jpg";
const TILE = 350;
const COLS = 4;
const GAP = 6;
const LABEL_H = 38;
...
const headerSvg = Buffer.from(`
  <svg width="${pageW}" height="${HEADER_H}" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="20" y="38" font-family="sans-serif" font-size="26" font-weight="bold" fill="#fff">Style 2 verify (color → assignment)</text>
  </svg>`);
