...
const slides = [
  ...
  },
  {
    ...
    ctaPrimary: { label: "Acheter Trail", href: "/shoes" },
    ctaSecondary: { label: "Guide du Trail", href: "/blog/running-route-vs-trail" },
  ...
  },
  {
    ...
    ctaSecondary: { label: "Conseils Running", href: "/blog" },
